...
func (_c *MockCollector_ProcessPage_Call) Return(_a0 error) *MockCollector_ProcessPage_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockCollector) String() string {
	ret := _m.Called()
...
func (_c *MockCollector_String_Call) Return(_a0 string) *MockCollector_String_Call {
	_c.Call.Return(_a0)
	return _c
}
