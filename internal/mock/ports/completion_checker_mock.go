...
// IsCompleted provides a mock function for the type MockCompletionChecker
func (_mock *MockCompletionChecker) IsCompleted(url string) (bool, error) {
...
func (_c *MockCompletionChecker_IsCompleted_Call) Return(b bool, err error) *MockCompletionChecker_IsCompleted_Call {
	_c.Call.Return(b, err)
	return _c
}

func (_c *MockCompletionChecker_IsCompleted_Call) RunAndReturn(run func(url string) (bool, error)) *MockCompletionChecker_IsCompleted_Call {
	_c.Call.Return(run)
	return _c
}
